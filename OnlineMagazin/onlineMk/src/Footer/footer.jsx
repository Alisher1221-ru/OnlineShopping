...
export default function Footer() {
    return(
        <Box bg={"gray.200"} display={"flex"} justifyContent={"space-between"} flexDirection={{base:"column",lg:"unset"}} w={"100%"} p={{base:"10px 15px",md:"10px 50px",lg:"20px 60px", xl:"30px 100px"}}  >
            <Box w={{base:"100%",lg:'20%' , xl:"25%"}} textAlign={{base:"center", lg:"start"}} display={{base:"flex", lg:"block"}} flexDirection={{base:"column", lg:"unset"}} alignItems={"center"} justifyContent={"center"}>
                <img className="Logo__Chor" src={img__icon} width={"200px"} alt="" />
